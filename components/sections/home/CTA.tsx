        ...
        <div className="flex relative z-10">
          <div className="flex flex-col gap-2 text-white w-2/5">
            ...
            <div className="flex gap-2 mt-8">
              <Button variant='secondary' className=' shadow-[0px_0px_8px_2px_white] w-[200px]' >Sign up</Button>
              <Button variant='secondary' className=' bg-transparent border border-gray-300 text-white w-[200px] hover:bg-gray-300/20' >Book call</Button>
