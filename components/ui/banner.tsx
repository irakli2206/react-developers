...
export default function Banner() {
    ...
    return (
        <>
            {isVisible && <div className="absolute top-[56px] left-0 w-full  flex items-center gap-x-6 overflow-hidden bg-zinc-900 text-white px-6 py-1 sm:px-3.5 sm:before:flex-1">
