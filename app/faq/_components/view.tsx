...
const FAQView = () => {
    ...
    const accordionData = [
        {
            question: "Why not include other tech other than ReactJS?",
            answer: "We decided that it would be better and clearer both for employers and developers if we focus this platform specifically on React developers. Many other platforms become cluttered with developers who possess varying skillsets that might make it harder for the employer to find the right finds."
        },
        {
            question: "What do I have to do as a developer?",
            answer: "Sign up and tell us more about yourself, that's it! If any employers become ineterested in you, they will reach out to you."
        },
        {
            question: "How is this better than traditional job boards?",
            answer: `
            Traditional job boards consume more money and time for the employer, and more time and effort for the developer. According to research conducted by the Society for Human Resource Management (SHRM), the average cost per hire for companies in the United States was around $4,129 in 2020. This includes expenses related to sourcing, recruiting, interviewing, hiring, and onboarding a new employee.
        ...
        },
        {
            ...
            answer: `Canceling the subscription is a simple process. Simply go to the billing section in your dashboard => Manage subscriptions => Cancel plan. Your subscription features will be revoked once the subscription period ends. You can also renew the subscription before the period end.`
        },
        {
            question: "Can I register as a non-ReactJS developer?",
            answer: `Technically, you can, but you won't be sought by the employers.`
        },
        {
            question: "Do I have to pass a test to register?",
            answer: `No. Registration itself does not require passing any tests. However, we plan to add certain verification tests to check your React proficiency. Passing this verification will give you a badge that demonstrates your proficiency to the employer.`
        },
    ]
