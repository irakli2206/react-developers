...
const FAQView = () => {
    ...
    const accordionData = [
        ...
        {
            question: "Why use Devvyx when there's Upwork?",
            answer: `Unlike Upwork, where developers often charge extra to cover platform fees up to 20% of the hourly rate, Devvyx operates differently. Developers set their base rates, eliminating the need for additional hourly charges. Instead, Devvyx employs a subscription-based model, offering more transparency and potentially cost-effective solutions for clients.`
        },
        {
    ...
    return (
        <div className=' min-h-screen w-full flex justify-center items-start py-32 relative'>
            <main className="max-w-7xl container flex flex-col relative z-10 mx-auto">
                ...
                <h1 className="text-3xl md:text-4xl xl:text-5xl font-semibold">Everything you need to know about Devvyx</h1>
